...
export default function Contact() {
  ...
  const socials = [
    { icon: FiGithub, label: 'GitHub', href: 'https://github.com/vpssanthosh', color: 'hover:text-gray-400' },
    { icon: FiLinkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/santhosh-v-5319a3379', color: 'hover:text-blue-400' },
    { icon: FiMail, label: 'Email', href: 'mailto:vpssanthosh43@gmail.com', color: 'hover:text-cyan' },
  ]
  ...
  return (
    <section id="contact" className="py-24 md:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div className="glass-card">
        <h3 className="text-xl font-bold text-[var(--text-color)] mb-6">Contact Information</h3>
        <div className="space-y-5">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-primary to-cyan text-white flex-shrink-0">
              <FiMail size={20} />
            </div>
            <div>
              <p className="text-xs text-[var(--muted-color)] uppercase tracking-wider mb-0.5">Email</p>
              <a href="mailto:vpssanthosh43@gmail.com" className="text-[var(--text-color)] hover:text-primary transition-colors duration-300 font-medium text-sm">
                vpssanthosh43@gmail.com
              </a>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-cyan to-primary text-white flex-shrink-0">
              <FiPhone size={20} />
            </div>
            <div>
              <p className="text-xs text-[var(--muted-color)] uppercase tracking-wider mb-0.5">Phone</p>
              <p className="text-[var(--text-color)] font-medium text-sm">7200815106</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-primary to-cyan text-white flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-[var(--text-color)] font-medium text-sm">India</p>
            </div>
          </div>
        </div>
      </div>
                ...
                {socials.map(social => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[var(--muted-color)]">@{social.label.toLowerCase()}</p>
                    </div>
                  </a>
                ))}
              </div>
          ...
          >
            <div className="glass-card">
              <h3 className="text-xl font-bold text-[var(--text-color)] mb-6">Send Me a Message</h3>
              {submitted ? (
                <motion.div
